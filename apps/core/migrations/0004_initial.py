...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Producto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('categoria_producto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.CategoriaProducto'], db_column='categoria_producto')),
        ...
        db.create_table('cliente_datos', (
            ...
            ('sucursal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Sucursal'], db_column='sucursal')),
        ...
        db.create_table('cliente_facturacion', (
            ...
            ('cliente_datos', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ClienteDatos'], db_column='cliente_datos')),
        ))
        ...
        db.create_table('sucursal_inventario', (
            ...
            ('rango', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Rango'], db_column='rango')),
            ('sucursal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Sucursal'], db_column='Sucursal_id')),
            ('costo', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='costo', blank=True)),
            ('stock', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='stock', blank=True)),
        ))
        ...
        db.create_table('estados', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('estado', self.gf('django.db.models.fields.CharField')(max_length=60L)),
        ))
        db.send_create_signal(u'core', ['Estados'])

        # Adding model 'Municipios'
        db.create_table('municipios', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('estado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Estados'], db_column='estado')),
            ('municipio', self.gf('django.db.models.fields.CharField')(max_length=49L, blank=True)),
        ))
        db.send_create_signal(u'core', ['Municipios'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('estados')

        # Deleting model 'Municipios'
        db.delete_table('municipios')
    ...
    models = {
        ...
        u'core.clientedatos': {
            ...
            'sucursal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Sucursal']", 'db_column': "'sucursal'"}),
        ...
        u'core.clientefacturacion': {
            ...
            'cliente_datos': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.ClienteDatos']", 'db_column': "'cliente_datos'"}),
        ...
        u'core.estados': {
            'Meta': {'object_name': 'Estados', 'db_table': "'estados'"},
            'estado': ('django.db.models.fields.CharField', [], {'max_length': '60L'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'core.eventos': {
        ...
        u'core.municipios': {
            'Meta': {'object_name': 'Municipios', 'db_table': "'municipios'"},
            'estado': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Estados']", 'db_column': "'estado'"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'municipio': ('django.db.models.fields.CharField', [], {'max_length': '49L', 'blank': 'True'})
        },
        u'core.producto': {
            'Meta': {'object_name': 'Producto', 'db_table': "'Producto'"},
            'categoria_producto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.CategoriaProducto']", 'db_column': "'categoria_producto'"}),
        ...
        u'core.sucursalinventario': {
            ...
            'costo': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'db_column': "'costo'", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'producto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Producto']", 'db_column': "'Producto_id'"}),
            'rango': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Rango']", 'db_column': "'rango'"}),
            'stock': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'db_column': "'stock'", 'blank': 'True'}),
